...
namespace DapperDemo.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public CompaniesController(ICompanyRepository compRepository)
        {
        ...
        {
            return View(_compRepository.GetAll());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var company =  _compRepository.Find(id.GetValueOrDefault());
            if (company == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Edit(int id, [Bind("CompanyId,Name,Address,City,State,PostalCode")] Company company)
        {
            ...
            if (ModelState.IsValid)
            {
					...
					_compRepository.Update(company);
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            if (id == null)
            {
             ...
             _compRepository.Remove(id.GetValueOrDefault());
            return RedirectToAction(nameof(Index));
        }
    }
}
